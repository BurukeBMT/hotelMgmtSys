...
function standardizeName(type, name) {
  ...
  return name.replace(isPreset ? BABEL_PRESET_PREFIX_RE : BABEL_PLUGIN_PREFIX_RE, `babel-${type}-`).replace(isPreset ? BABEL_PRESET_ORG_RE : BABEL_PLUGIN_ORG_RE, `?${type}-`).replace(isPreset ? OTHER_PRESET_ORG_RE : OTHER_PLUGIN_ORG_RE, `?babel-${type}-`).replace(OTHER_ORG_DEFAULT_RE, `?/babel-${type}`).replace(EXACT_RE, "");
}
